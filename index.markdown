...
<br>
<br>
Debjyoti Bhattacharjee is a Principal Member of Technical Staff in the <a href="https://www.imec-int.com/en/expertise/compute-system-architecture">Compute System Architecture (CSA)</a> unit at <a href="https://www.imec.be/" target="_blank">imec</a>, Leuven. He is also affiliated to KU Leuven as a part-time ZAP Professor. His current research spans CMOS2.0-driven architecture design, system architecture and performance modelling, hardware-software co-design, and mapping algorithms for machine learning workloads and accelerators.
